...
class FileLoader:
    ...
    def _retrieve_localdir_from_syncfile(self):
        ...
        try:
            ...
            FROM sync_file WHERE processed = 1 and modified_date >= '2024-11-11'
            AND (decrypted_file_name ilike 'prep_eligibility_%' or decrypted_file_name ILIKE 'prep_clinic_%' or decrypted_file_name ilike 'pmtct_anc_%' or decrypted_file_name ilike 'dsd_devolvement%' or decrypted_file_name ilike 'hiv_art_clinical%')
