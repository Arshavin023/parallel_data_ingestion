...
@patch("records_ingestion.multi_file_ingestion_process.update_facility_uploads")
@patch("records_ingestion.multi_file_ingestion_process.FileLoader")
...
@patch("records_ingestion.multi_file_ingestion_process.create_single_instance")
@patch("records_ingestion.multi_file_ingestion_process.insert_pipeline_log")
@patch("records_ingestion.multi_file_ingestion_process.update_pipeline_log")
@patch("records_ingestion.multi_file_ingestion_process.connect_to_db.connect")
...
@patch("records_ingestion.multi_file_ingestion_process.process_facilities_in_batches")
@patch("records_ingestion.multi_file_ingestion_process.insert_facility_uploads")
@patch("records_ingestion.multi_file_ingestion_process.connect_to_db.connect")
