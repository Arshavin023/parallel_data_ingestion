...
from records_ingestion.multithread_file_loader_v4 import FileLoader
import configparser
...
# from records_ingestion.schema_alignment_sameserver import run_schema_alignment
...
def insert_facility_uploads():
    ...
    insert_query = """
        ...
        FROM (
            ...
            FROM sync_file
            WHERE processed = 1
              AND modified_date >= CURRENT_DATE - INTERVAL '30 DAYS'
        ) z
        --WHERE facility_id='SC6fbTfQufS'
