...
class FileLoader:
    ...
    def _retrieve_localdir_from_syncfile(self):
        ...
        try:
            ...
            AND NOT (decrypted_file_name ilike 'hiv_art_clinical%' or decrypted_file_name ILIKE 'pmtct_anc%' or decrypted_file_name ILIKE 'dsd_devolvement%' or decrypted_file_name ilike 'mhpss_confirmation%')
    ...
    def _ingest_json_data(self, file_path, staging_table, dtype=None, parse_dates=None):
        ...
        try:
            ...
            if validation_result:
                #validation_result_truncated = validation_result[:5000]
